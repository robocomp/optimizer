...
/** \mainpage RoboComp::dwa_cpp
 *
 * \section intro_sec Introduction
 *
 * The dwa_cpp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dwa_cpp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dwa_cpp : public RoboComp::Application
{
public:
	dwa_cpp (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::dwa_cpp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	tprx = std::make_tuple(billcoppelia_proxy,differentialrobot_proxy,fullposeestimation_proxy,laser_proxy,omnirobot_proxy);
...
int main(int argc, char* argv[])
{
	...
	::dwa_cpp app(prefix, startup_check_flag);
