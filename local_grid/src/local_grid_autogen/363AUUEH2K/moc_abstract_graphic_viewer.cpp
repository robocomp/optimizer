...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AbstractGraphicViewer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AbstractGraphicViewer_t qt_meta_stringdata_AbstractGraphicViewer = {
    {
QT_MOC_LITERAL(0, 0, 21), // "AbstractGraphicViewer"
QT_MOC_LITERAL(1, 22, 21), // "new_mouse_coordinates"
...
void AbstractGraphicViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->new_mouse_coordinates((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject AbstractGraphicViewer::staticMetaObject = { {
    &QGraphicsView::staticMetaObject,
    qt_meta_stringdata_AbstractGraphicViewer.data,
