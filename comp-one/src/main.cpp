...
/** \mainpage RoboComp::compone
 *
 * \section intro_sec Introduction
 *
 * The compone component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/compone --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class compone : public RoboComp::Application
{
public:
	compone (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::compone::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::compone app(prefix, startup_check_flag);
