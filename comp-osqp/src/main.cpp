...
/** \mainpage RoboComp::composqp
 *
 * \section intro_sec Introduction
 *
 * The composqp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/composqp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class composqp : public RoboComp::Application
{
public:
	composqp (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::composqp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::composqp app(prefix, startup_check_flag);
